...
class MatchDetailOwnerVC: UIViewController{
    ...
    override func viewDidLoad() {
        ...
        let _ = OwnerProfile(id: friendOwnerId, completion: { (friendOwer) in
            ...
            let commonTime = friendOwer.freeTime.getCommonFreeTime(other: OwnerProfile.most_recent_owner!.freeTime)
            ...
            for view in self.view.subviews as [UIView] {
                if let imageView = view as? UIImageView {
                    ...
                    imageView.backgroundColor = commonTime.isFree(weekDay: week, partDay: part) ?
